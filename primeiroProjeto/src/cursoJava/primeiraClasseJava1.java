...
public class primeiraClasseJava1 {
	public static void main(String[] args) {
		 ...
		 * idade = JOptionPane.showInputDialog("idade do aluno?"); String dataNascimento
		 * = JOptionPane.showInputDialog("Data de nascimento"); String registroGeral =
		 * JOptionPane.showInputDialog("Nº RG"); String numeroCpf =
		 ...
		 * JOptionPane.showInputDialog("Série da matrícula"); String nota1 =
		 * JOptionPane.showInputDialog("Primeira nota"); String nota2 =
		 * JOptionPane.showInputDialog("Segunda nota"); String nota3 =
		 * JOptionPane.showInputDialog("Terceira nota"); String nota4 =
		 * JOptionPane.showInputDialog("Quarta nota");
		 * 
		 ...
		 * System.out.println("A série do matriculado é o " +
		 * aluno1.getSerieMatriculado()); System.out.println("A média do aluno é " +
		 * aluno1.getMediaNota()); System.out.println("Resultado é: " +
